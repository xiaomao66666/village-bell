...
Run-Checked "$buildTools\aapt2.exe" @('link','-o',"$outputRoot\unsigned.apk",'-I',$androidJar,'--manifest',"$outputRoot\AndroidManifest.xml",'--java',"$outputRoot\generated",'--min-sdk-version','26','--target-sdk-version','35','--version-code','3','--version-name','0.3.0',"$outputRoot\resources.zip")
...
$apk = Join-Path $distRoot 'village-bell-0.3.0.apk'
